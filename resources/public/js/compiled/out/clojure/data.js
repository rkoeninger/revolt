...
return cljs.core.reduce.call(null,(function (result,p__19008){
var vec__19009 = p__19008;
var k = cljs.core.nth.call(null,vec__19009,(0),null);
var v = cljs.core.nth.call(null,vec__19009,(1),null);
...
var vec__19011 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__19011,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__19011,(1),null);
var ab = cljs.core.nth.call(null,vec__19011,(2),null);
...
return cljs.core.vec.call(null,cljs.core.map.call(null,clojure.data.vectorize,clojure.data.diff_associative.call(null,((cljs.core.vector_QMARK_.call(null,a))?a:cljs.core.vec.call(null,a)),((cljs.core.vector_QMARK_.call(null,b))?b:cljs.core.vec.call(null,b)),cljs.core.range.call(null,(function (){var x__16459__auto__ = cljs.core.count.call(null,a);
var y__16460__auto__ = cljs.core.count.call(null,b);
return ((x__16459__auto__ > y__16460__auto__) ? x__16459__auto__ : y__16460__auto__);
})()))));
});
...
clojure.data.EqualityPartition = (function (){var obj19013 = {};
return obj19013;
})();
...
return (function (){var or__16142__auto__ = (clojure.data.equality_partition[goog.typeOf(x__16786__auto__)]);
if(or__16142__auto__){
return or__16142__auto__;
} else {
var or__16142__auto____$1 = (clojure.data.equality_partition["_"]);
...
clojure.data.Diff = (function (){var obj19015 = {};
return obj19015;
})();

clojure.data.diff_similar = (function diff_similar(a,b){
if((function (){var and__16130__auto__ = a;
if(and__16130__auto__){
...
var x__16786__auto__ = (((a == null))?null:a);
return (function (){var or__16142__auto__ = (clojure.data.diff_similar[goog.typeOf(x__16786__auto__)]);
if(or__16142__auto__){
return or__16142__auto__;
} else {
var or__16142__auto____$1 = (clojure.data.diff_similar["_"]);
if(or__16142__auto____$1){
return or__16142__auto____$1;
} else {
...
if((function (){var G__19016 = x;
if(G__19016){
var bit__16823__auto__ = (G__19016.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__16823__auto__) || (G__19016.cljs$core$IMap$)){
return true;
} else {
if((!G__19016.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__19016);
} else {
return false;
}
}
...
if((function (){var G__19017 = x;
if(G__19017){
var bit__16823__auto__ = (G__19017.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__16823__auto__) || (G__19017.cljs$core$ISet$)){
return true;
} else {
if((!G__19017.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__19017);
} else {
return false;
}
}
...
if((function (){var G__19018 = x;
if(G__19018){
var bit__16823__auto__ = (G__19018.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__16823__auto__) || (G__19018.cljs$core$ISequential$)){
return true;
} else {
if((!G__19018.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__19018);
} else {
return false;
}
}
...
return (function (){var G__19019 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__19019) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1431886643180